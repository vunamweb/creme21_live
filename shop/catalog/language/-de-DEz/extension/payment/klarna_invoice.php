...
$_['text_terms_fee']			= '<span id="klarna_invoice_toc"></span> (+%s)<script type="text/javascript">var Begriffe = neue Klarna. Terms. Rechnung ({El: \' klarna_invoice_toc \', Eid: \'%s", Land:"%s\', Charge: %s});</script>';
$_['text_terms_no_fee']			= '<span id="klarna_invoice_toc"></span><script type="text/javascript">var Begriffe = neue Klarna. Terms. Rechnung ({El: \' klarna_invoice_toc \', Eid: \'%s", Land:"%s\'});</script>';
...
$_['text_month']				= 'Monat';
$_['text_day']					= 'Tag';
$_['text_comment']				= 'Klarnas Rechnungs Ausweis: %s. ' . "\n" . '%s/%s: %.4f';
