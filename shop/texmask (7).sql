...
--
-- Hôte : 127.0.0.1
-- Généré le : Dim 19 avr. 2020 à 05:43
...
--
-- Base de données : `texmask`
--
CREATE DATABASE IF NOT EXISTS `texmask` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `texmask`;
...
--
-- Structure de la table `oc_advertise_google_target`
--
...
(1, 'Default', '', 1, '2020-04-19 10:27:43', '2020-04-19 10:27:43');
...
--
-- Structure de la table `oc_category_to_google_product_category`
--
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2020-04-19 03:41:26'),
...
--
-- Structure de la table `oc_product_advertise_google`
--
...
--
-- Structure de la table `oc_product_advertise_google_status`
--
...
--
-- Structure de la table `oc_product_advertise_google_target`
--
...
('05692f7214d701457cbe49441f', '{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"G6wTOrSD1WeWi5fhdjmGrAjyJQbW4FsE\"}', '2020-04-19 04:05:41');
...
(201, 0, 'config', 'config_email', 'vukynamkhtn@gmail.com', 0),
...
(202, 0, 'config', 'config_encryption', '', 0),
...
(1, 1, 'admin', '51fe4a59a8bf96e3edd43733a35a346ed2746993', 'Durn3D27P', 'John', 'Doe', 'vukynamkhtn@gmail.com', '', '', '::1', 1, '2020-04-19 10:27:43');
...
--
-- Index pour la table `oc_advertise_google_target`
--
...
--
-- Index pour la table `oc_category_to_google_product_category`
--
...
--
-- Index pour la table `oc_product_advertise_google`
--
...
--
-- Index pour la table `oc_product_advertise_google_status`
--
ALTER TABLE `oc_product_advertise_google_status`
  ADD PRIMARY KEY (`product_id`,`store_id`,`product_variation_id`);

--
-- Index pour la table `oc_product_advertise_google_target`
--
