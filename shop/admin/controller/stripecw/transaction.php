...
class ControllerStripeCwTransaction extends StripeCw_AbstractController {
	...
	public function view($data = array()){
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('stripecw/transaction', 'user_token=' . $this->session->data['user_token'], 'SSL'),
			'separator' => ' :: ' 
		);
		...
		$this->response->setOutput(
				$this->renderView('stripecw/transaction/view', $data, array(
					'common/header',
					'common/footer' 
				)));
	}
	...
	public function refund(){
		...
		$this->response->setOutput(
				$this->renderView('stripecw/transaction/refund', $data, array(
					'common/header',
					'common/footer' 
				)));
	}
	...
	public function capture(){
		...
		$this->response->setOutput(
				$this->renderView('stripecw/transaction/capture', $data, array(
					'common/header',
					'common/footer' 
				)));
	}
	...
	public function view_capture(){
		...
		$this->response->setOutput(
				$this->renderView('stripecw/transaction/capture_view', $data, array(
					'common/header',
					'common/footer' 
				)));
	}
	...
	public function view_refund(){
		...
		$this->response->setOutput(
				$this->renderView('stripecw/transaction/refund_view', $data, array(
					'common/header',
					'common/footer' 
				)));
	}
	...
	protected function getList(){
		...
		$renderer = new StripeCw_Grid_Renderer($loader, 
				$this->url->link('stripecw/transaction', 'user_token=' . $this->session->data['user_token'], 'SSL'));
		...
		$this->response->setOutput(
				$this->renderView('stripecw/transaction/list', $data, array(
					'common/header',
					'common/footer' 
				)));
	}
