...
(356, 20, 0, 'product/product'),
(354, 14, 0, ''),
(355, 17, 0, 'common/home'),
(353, 8, 0, 'product/category');
-- --------------------------------------------------------
--
...
UPDATE `oc_setting` SET `value` = '14' WHERE `oc_setting`.`key` = 'config_layout_id';
UPDATE `oc_setting` SET `value` = '14' WHERE `oc_setting`.`key` = 'config_compression';
...
UPDATE `oc_setting` SET `value` = 'tt_naturecircle4' WHERE `oc_setting`.`key` = 'theme_default_directory';
