 ...
 * @Bean
 */
class Customweb_Saferpay_Method_Factory extends Customweb_Payment_Authorization_Method_AbstractFactory{
	
	protected function getMethodPackages() {
		return array('Customweb_Saferpay_Method');
	}
	
	/**
	 * @return Customweb_Saferpay_Method_Default
	 */
