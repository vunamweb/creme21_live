...
class Customweb_Saferpay_ParameterBuilder_BackendOperation_Capture extends Customweb_Saferpay_ParameterBuilder_BackendOperation_AbstractBase {
	...
	public function buildParameters($amount){
		$parameters = array(
			...
			'TransactionReference' => $this->getTransactionReferenceParamters(),
		);
		
		$paymentMethod = $this->getContainer()->getPaymentMethodByTransaction($this->getTransaction());
		$parameters = array_merge($parameters, $paymentMethod->getAdditionalCaptureParameters());
