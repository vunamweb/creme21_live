...
abstract class Customweb_Saferpay_ParameterBuilder_BackendOperation_AbstractBase extends Customweb_Saferpay_ParameterBuilder_AbstractBase {
	...
	protected function getAmountParameters($amount){
