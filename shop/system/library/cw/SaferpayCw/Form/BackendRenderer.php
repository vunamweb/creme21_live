...
class SaferpayCw_Form_BackendRenderer extends SaferpayCw_Form_FrontendRenderer {
	private $configurationAdapter = null;

	public function __construct(){
		$this->configurationAdapter = new SaferpayCw_Configuration();
	}

	protected function renderElementScope(Customweb_Form_IElement $element){
		if ($this->configurationAdapter->getStoreHierarchy() === null ||
				 SaferpayCw_Store::getStoreId() == SaferpayCw_Store::DEFAULT_STORE_ID) {
			return '';
		}
