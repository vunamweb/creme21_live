...
class SaferpayCw_LayoutController extends SaferpayCw_AbstractController
{
	/**
	...
	public function __construct(Customweb_Mvc_Layout_IRenderContext $context) {
		parent::__construct(SaferpayCw_Util::getRegistry());
	...
	public function getContent() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/saferpaycw/default.twig')) {
			$template = $this->config->get('config_template') . '/template/saferpaycw/default';
		}
		else {
			$template = 'default/template/saferpaycw/default';
		}
