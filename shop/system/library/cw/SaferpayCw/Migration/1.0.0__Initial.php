...
class SaferpayCw_Migration_1_0_0 implements Customweb_Database_Migration_IScript{
	...
	public function execute(Customweb_Database_IDriver $driver) {
		...
		$driver->query("CREATE TABLE IF NOT EXISTS " . DB_PREFIX . "saferpaycw_customer_contexts (
		...
		$driver->query("CREATE TABLE IF NOT EXISTS `saferpaycw_storage` (
		...
		$driver->query("CREATE TABLE IF NOT EXISTS " . DB_PREFIX . "saferpaycw_transactions (
		...
		SaferpayCw_Database::getInstance()->query("ALTER TABLE " . DB_PREFIX . "extension CHANGE `code` `code` VARCHAR( 64 )");
		
		SaferpayCw_OrderStatus::installOrderStatuses();
