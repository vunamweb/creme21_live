...
class SaferpayCw_PaymentMethodWrapper implements Customweb_Payment_Authorization_IPaymentMethod, SaferpayCw_IPaymentMethodDefinition {
	...
	public function __construct(SaferpayCw_PaymentMethod $method) {
	...
	/**
	 * @return  SaferpayCw_PaymentMethod
	 */
	protected function getMethod() {
		if ($this->method === null) {
			$this->method = new SaferpayCw_PaymentMethod($this);
		}
		return $this->method;
	}
