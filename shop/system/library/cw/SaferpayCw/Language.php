...
class SaferpayCw_Language {
	...
	public static function getLanguages(){
		if (self::$languages === null) {
			...
			$rs = SaferpayCw_Database::getInstance()->query("SELECT * FROM `" . DB_PREFIX . "language`");
			while (($row = SaferpayCw_Database::getInstance()->fetch($rs)) !== false) {
	...
	public static function getCurrentLanguageId(){
		$config = SaferpayCw_Util::getRegistry()->get('config');
