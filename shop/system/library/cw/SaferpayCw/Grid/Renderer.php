...
class SaferpayCw_Grid_Renderer extends Customweb_Grid_Renderer {
	...
	public function getInfoPattern() {
		return SaferpayCw_Language::_('Showing !startingItem to !endingItem of !totalItems items.');
	}
	
	public function getSubmitButtonLabel() {
		return SaferpayCw_Language::_('Apply');
	}
