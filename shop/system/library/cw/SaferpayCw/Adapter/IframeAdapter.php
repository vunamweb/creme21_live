 ...
 * @Bean
 */
class SaferpayCw_Adapter_IframeAdapter extends SaferpayCw_Adapter_AbstractAdapter {
	...
	protected function preparePaymentFormPane(){
		...
		if ($this->visibleFormFields !== null && count($this->visibleFormFields) > 0) {
			$this->formActionUrl = SaferpayCw_Util::getUrl('process', 'iframe', 
					array(
	...
	public function getIframe(){
		if ($this->iframeUrl !== null) {
			return '<iframe class="saferpaycw-iframe" src="' . $this->iframeUrl . '" style="height: ' . $this->iframeHeight . 'px;"></iframe>';
		}
		else {
