...
class SaferpayCw_TransactionContext implements Customweb_Payment_Authorization_PaymentPage_ITransactionContext,
...
Customweb_Payment_Authorization_IUpdateTransactionContext, Customweb_Payment_Authorization_Widget_ITransactionContext
{
	...
	public function __construct(SaferpayCw_Entity_Transaction $transaction, SaferpayCw_OrderContext $orderContext, $aliasTransactionId = NULL) {
		...
		$this->paymentCustomerContext = SaferpayCw_Util::getPaymentCustomerContext($orderContext->getCustomerId());
	...
	public function getDatabaseTransaction() {
		if ($this->databaseTransaction === NULL) {
			$this->databaseTransaction = SaferpayCw_Entity_Transaction::loadById($this->databaseTransactionId);
		}
	...
	public function getAlias() {
		...
		if ($this->aliasTransactionId !== null) {
			$transcation = SaferpayCw_Entity_Transaction::loadById($this->aliasTransactionId);
	...
	public function getSuccessUrl() {
		return SaferpayCw_Util::getUrl('process', 'success', array(), true);
	}

	public function getFailedUrl() {
		return SaferpayCw_Util::getUrl('process', 'failed', array(), true);
	}
	...
	public function getNotificationUrl() {
		return SaferpayCw_Util::getUrl('process', 'notify', array(), true);
	}

	public function getIframeBreakOutUrl() {
		return SaferpayCw_Util::getUrl('process', 'iframe_breakout', array(), true);
	}

	public function getUpdateUrl() {
		return SaferpayCw_Util::getUrl('update', 'notify', array(), true);
	}
