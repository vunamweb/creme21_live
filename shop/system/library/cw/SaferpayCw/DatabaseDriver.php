...
require_once 'SaferpayCw/DatabaseStatement.php';
 ...
 *
 */
class SaferpayCw_DatabaseDriver extends Customweb_Database_Driver_AbstractDriver implements Customweb_Database_IDriver {
	...
	public function __construct(){
		$this->db = SaferpayCw_Util::getDatabaseObject();
	}
	...
	public function query($query){
		$statement = new SaferpayCw_DatabaseStatement($query, $this);
		return $statement;
	}
