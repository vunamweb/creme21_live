...
require_once 'SaferpayCw/Error.php';


class SaferpayCw_DatabaseStatement extends Customweb_Database_Driver_AbstractStatement {
	...
	final protected function executeQuery() {
		if (!$this->isQueryExecuted()) {
			SaferpayCw_Error::startErrorHandling();
			$this->result = $this->getDb()->query($this->prepareQuery());
			SaferpayCw_Error::endErrorHandling();
