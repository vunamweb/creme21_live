 ...
 * @Bean
 */
class SaferpayCw_EndpointAdapter extends Customweb_Payment_Endpoint_AbstractAdapter implements Customweb_Payment_Endpoint_IAdapter
{
	protected function getBaseUrl() {
		return SaferpayCw_Util::getUrl('endpoint');
	}
