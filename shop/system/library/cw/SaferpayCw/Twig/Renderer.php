 ...
 */
class SaferpayCw_Twig_Renderer extends Customweb_Mvc_Template_Renderer
{
	...
	public function __construct(Customweb_Asset_IResolver $assetResolver, Customweb_DependencyInjection_IContainer $container)
	{
		...
		require_once 'SaferpayCw/Twig/Environment.php';
require_once 'SaferpayCw/Twig/SecurityPolicy.php';
	...
	{		
		...
		$twig = new SaferpayCw_Twig_Environment($loader, $this->getCacheBackend());
		$policy = new SaferpayCw_Twig_SecurityPolicy($context->getSecurityPolicy());
