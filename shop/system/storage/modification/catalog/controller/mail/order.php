	...
	public function add($order_info, $order_status_id, $comment, $notify) {
		...
		foreach ($order_products as $order_product) {
			...
			$data['products'][] = array(
				...
				'tax' => $this->currency->format(round($order_product['total'] - $order_product['total']/1.16, 2), $order_info['currency_code'], $order_info['currency_value']),
        ...
        $this->document->displayOrder($order_totals);
		...
		$this->document->displayOrderAgain($data['totals'], $order_totals);
		...
		$data['comment'] = nl2br($order_info['comment']);
                ...
                $contentPdf = $this->load->view('mail/order_pdf', $data);
                //echo$contentPdf; die();
                //echo $contentPdf; die();
                ...
                $email_body = $this->load->view('mail/order_add', $data);
