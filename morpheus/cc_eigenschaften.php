...
///////////////////////////////////////////////////////////////////////////////////////
//// EDIT_SKRIPT
$um_wen_gehts 	= "Eigenschaften Artikel";
$titel			= "Eigenschaften Artikel";
///////////////////////////////////////////////////////////////////////////////////////
$table 		= 'cc_eigenschaften';
$tid 		= 'eID';
$nameField 	= "eName";
$sortField 	= 'eName';

$imgFolder = "../images/produktbeschreibung/";
$imgFolderShort = "produktbeschreibung/";
///////////////////////////////////////////////////////////////////////////////////////
...
$arr_form = array(
	array("eName", "Name", '<input type="Text" value="#v#" class="form-control" name="#n#" style="width:150px;" />'),
	array("eImg", "Background Image", 'foto', 'image', 'imgname', 6, 'gid'),
 	array("eDescription", "Beschreibung", '<textarea class="form-control" id="summernote" name="#n#">#v#</textarea>'),
...
';
	...
	<div class="zeile row"  id="'.$row->$tid.'">
			...
			<div class="col-md-2">
				<a href="?edit='.$edit.'">
					<img src="../mthumb.php?w=50&amp;src=images/'.$imgFolderShort.$row->eImg.'" class="" style="float:left;" />
				</a>
			</div>
			<div class="col-md-1 text-right">
				<a href="?copy='.$edit.'" class="btn btn-success"><i class="fa fa-copy"></i></a>
			</div>
			<div class="col-md-1 text-right">
...
<style type="text/css">
	...
	#queue { border: 1px solid #1997c6; margin-left: 100px; height: 100px; overflow: auto; margin-bottom: 10px; padding: 0 3px 3px; width: 200px; float: left; background: url(images/drag-drop.png) no-repeat center center; }
