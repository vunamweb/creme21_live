...
$arr_form = array(
		...
		array("eventAbstract", "Titel Abstract", '<input type="Text" value="#v#" class="form-control" name="#n#" required />'),

		array("eventKat", "Kategorie", '<input type="Text" value="#v#" class="form-control" name="#n#" required />'),
...
//		array("mid", "Ansprechpartner", 'sel2m', 'morp_mitarbeiter', 'name', 'vorname', 'mid'),
		...
		array("zusatz", "Uhrzeit", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
		array("preis", "Preis", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
		array("anmeldung", "Anzahl Teinehmer Beschreibung", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
		array("event_zusage", "Anmeldeschluss Freitext", '<textarea class="form-control" name="#n#" />#v#</textarea>'),
...
*/
		...
		$echo .= '			<tr'.($row->eventDatum < $heute ? ' class="warn"' : '').'>
			...
			<td>
				<a href="?edit='.$edit.'">'.$row->eventKat.' </a>
			</td>
			<td>
