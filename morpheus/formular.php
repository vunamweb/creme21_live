...
if ($neu || $edit) {
	...
	<form action="formular.php" method=post>
		...
		<p class="mt2"><input type="checkbox" name="extended" value="1" '. ($check ? 'checked' : '') .'> &nbsp;&nbsp; Erweitertes Formular - Einstellm&ouml;glichkeiten / Datenbankauswertung</p>

		<p class="mt2">Empf&auml;nger E-Mail</p>
		<p><input type="text" name="post" size="50" value="'.$post.'"></p>
		<p class="mt2">Betreff</p>
		<p><input type="text" name="betreff" size="50" value="'.$betreff.'"></p>
		<p class="mt2">Antwort, nachdem das Formular abgesendet worden ist.</p>
