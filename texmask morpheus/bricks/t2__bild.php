<?php
global $img_pfad, $ausrichtung, $ausrichtungArray, $dir, $imgGal, $imageFolder, $bild;
...
if($imgid) {
	...
	$bild = ($isLink ? '<a href="'.$dir.$isLink.'">' : '').'<img src="'.$imageFolder.$inm.'" alt="'.$altText.'" class="img-fluid" />'.($isLink ? '</a>' : '');
	// $imgGal = ' <img src="'.$imageFolder.$inm.'" alt="'.$altText.'" class="img-fluid">';
}
